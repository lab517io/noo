...
> exchange, and LAN peer sync; see `P2P_SYNC.md`. This document remains as
...
- Server: `app/` in the `noo-relay` repository (FastAPI, SQLite)
- Client: `client/lib/data/services/sync_service.dart`, `sync_api_client.dart`,
