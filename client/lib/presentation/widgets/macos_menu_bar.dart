...
class MacosMenuBar extends ConsumerWidget {
  ...
  List<PlatformMenuItem> _menus(WidgetRef ref) {
    ...
    return <PlatformMenuItem>[
      _appMenu(ref),
      _fileMenu(ref, hasDatabase: hasDatabase, syncAttempted: syncAttempted,
          peerCount: peerCount),
      _editMenu(),
        ...
        PlatformMenuItemGroup(
          members: <PlatformMenuItem>[
            ...
            PlatformMenuItem(
              label: 'Registration…',
              onSelected:
                  _action((context) => AppMenuBar.showRegistration(context, ref)),
            ),
          ],
        ),
        ...
        PlatformMenuItemGroup(
          members: <PlatformMenuItem>[
            ...
            if (syncAttempted)
              PlatformMenuItem(
                label: 'Sync Details…',
                onSelected: _action(showSyncProgressDialog),
              ),
          ],
        ),
      ],
