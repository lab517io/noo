...
/// before any password dialog appears.
///
...
class WelcomeScreen extends ConsumerStatefulWidget {
  final void Function(String path, {bool? create}) onPathChosen;
...
class _WelcomeScreenState extends ConsumerState<WelcomeScreen> {
  ...
  void _choseCreate(String path) => widget.onPathChosen(path, create: true);
