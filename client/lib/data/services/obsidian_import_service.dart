    ...
    try {
      ...
      Future<void> importDirectory(Directory dir, int? parentId, int orderOffset,
        ...
        for (final f in mdFiles) {
          ...
          // Skip if this .md matches a sibling directory (it will be handled via the dir)
          if (dirNames.contains(titleFromFile)) continue;
        ...
        for (final subDir in subDirs) {
          ...
          String? content;
          final selfMdFile = File('${subDir.path}/$dirName.md');
          ...
          final dirTimelineFile = File('${subDir.path}/timeline.txt');
