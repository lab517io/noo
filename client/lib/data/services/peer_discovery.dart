...
/// the probes' source addresses.
///
/// Discovery only runs while the user has Sync P2P open, so probes repeat on a
/// short timer: someone is watching the device list fill in, and a peer that
/// closed its dialog should drop out of it quickly.
class PeerDiscovery {
  ...
  PeerDiscovery({
    ...
    this.peerExpiry = const Duration(seconds: 10),
  });
