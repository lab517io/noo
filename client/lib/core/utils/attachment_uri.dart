...
/// that already exists: a packet names the content by its hash (`blob:<sha256>`,
/// see `SyncChangePackager`), and the bytes themselves go through the relay's
/// or a peer's blob store once, only when they change.
///
