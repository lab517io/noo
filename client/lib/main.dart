...
/// Hands the bundled console fonts' licences to Flutter's licence list, where
/// Help → About shows them.
///
/// The OFL asks that it travel with the font wherever the font goes, and an
/// app binary is one of those places — a licence sitting only in the source
/// tree does not reach anyone running the app.
void _registerBundledFontLicences() {
  LicenseRegistry.addLicense(() async* {
    for (final family in kMonospaceFonts) {
      final file = 'assets/fonts/OFL-${family.replaceAll(' ', '')}.txt';
