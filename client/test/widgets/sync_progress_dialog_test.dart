...
void main() {
  ...
  testWidgets('successful sync lists summary and changes', (tester) async {
    ...
    // Where each changed node is, under its line.
    expect(find.text('in Work › Q3'), findsOneWidget);
    expect(find.text('at top level'), findsOneWidget);
          ...
          controller.finish(const SyncResult(
            ...
            applied: [
              SyncEntityChange(
                ...
                // Longer than the line: it wraps rather than overflowing.
                path: [
                  'Clients',
                  'Northwind Traders',
                  'Quarterly planning',
